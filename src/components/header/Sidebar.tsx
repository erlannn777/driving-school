          ...
          <div className="flex items-start h-full justify-center min-h-screen text-center">
            ...
            >
              <div
                className="
              max-w-xs
               ml-auto fixed left-0 w-full h-full shadow-xl py-4 pb-12 flex flex-col
               overflow-y-auto bg-white text-black p-5
               dark:bg-black dark:border-white dark:border-opacity-20 dark:border-l-2
               "
              >
                <div
                ...
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-7 w-7 fill-black text-black z-40 dark:text-white"
                    fill="#000"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                      ...
                      {links.map((item) => {
                        ...
                        return (
                          <li key={id} className="py-1">
                            <a
                              href={url}
                              className="flex items-center gap-3 text-xl font-light"
                            >
                              <span>{icon}</span>
