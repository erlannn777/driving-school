    ...
    return (
        <Transition.Root show={showError.open} as={Fragment}>
            ...
            &#8203;
                    ...
                    >
                        <div
                            className="relative z-30 lg:w-1/4 dark:bg-white inline-block align-center align-middle rounded-xl bg-white border-2 border-gray  text-center overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl">
                            <div
